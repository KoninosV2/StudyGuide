        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input type="text" name="ability-order" class="font-weight-normal form-control" value="<?php echo $ability['ability_order']; ?>">
						</div>
            <div class="form-group col-md-2">
							<label for="ability-short-title" class="col-form-label font-weight-bold text-gray-800">Κωδικός:</label>
							<input type="text" name="ability-short-title" class="font-weight-normal form-control" value="<?php echo $ability['ability_short_title']; ?>" readonly>
						</div>
          </div>
						<div class="form-group">
							<label for="ability-title" class="col-form-label font-weight-bold text-gray-800">Τίτλος:</label>
							<input type="text" name="ability-title" class="font-weight-normal form-control" value="<?php echo $ability['ability_title']; ?>">
						</div>
            <div class="form-group">
