						...
						<div class="collapse" id="newAbility">
							<div class="card card-body">
								<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" id="new-ablt-form">
									...
									<div class="form-group">
										<input type="submit" id="new-ability-submit" class="btn btn-success float-right" name="new-ability" value="Προσθήκη">
									</div>
								</form>
							</div>
						</div>
						...
						<div class="form-group">
							...
							?>
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input abilities-checkbox" name="ability[]" id="customCheck<?php echo $row_count; ?>" value="<?php echo $row['ability_short_title']; ?>" <?php echo is_null($row['lesson_code']) ?: 'checked' ?>>
				...
				<div class="tab-pane fade" id="pills-contact" role="tabpanel">
					<form method="POST" action="includes/handle_edit_lesson.php" id="edit-lesson-assessment">
						...
						<div class="form-group">
							...
							?>
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input assessment-checkbox" name="assessment[]" id="assessmentCheck<?php echo $row_count; ?>" value="<?php echo $row['assessment_short_title']; ?>" <?php echo is_null($row['lesson_code']) ?: 'checked' ?>></input>
						...
						<div class="collapse" id="newWeek">
							<div class="card card-body">
								<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" id="new-week-schedule">
									...
									<div class="form-group">
										<input type="submit" class="btn btn-success float-right" name="new-week-submit" value="Προσθήκη">
									</div>
								</form>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="pills-organize" role="tabpanel">
					<div class="row mb-3">
						<form action="includes/handle_edit_lesson.php" method="POST" id="update-teach-organize-form">
							...
							<?php
							$names = [
								"lecture", "seminar", "exercise_lab", "field_exercise", "bibliography",
				...
				<div class="tab-pane fade" id="pills-tech" role="tabpanel">
						...
						<div class="collapse" id="newWeek">
							<div class="card card-body">
								<form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" id="new-tech-form">
									...
									<div class="form-group">
										<input type="submit" id="new-tech-submit" class="btn btn-success float-right" name="new-tech" value="Προσθήκη">
									</div>
								</form>
							</div>
						</div>
					...
					<form method="POST" action="includes/handle_edit_lesson.php" id="edit-lesson-tech">
						...
						<div class="form-group">
							...
							?>
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input tech-checkbox" name="tech[]" id="techCheck<?= $row_count; ?>" value="<?php echo $row['tech_short_title']; ?>" <?php echo is_null($row['lesson_code']) ?: 'checked' ?>></input>
