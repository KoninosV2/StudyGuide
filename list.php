            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                  ...
                  <tbody>
                   <?php
						$que = $db->prepare("SELECT DISTINCT lesson.lesson_code,title,cat_id,semester,teacher2lesson.teacher_id FROM lesson, teacher2lesson WHERE teacher2lesson.lesson_code = lesson.lesson_code");
			  			$que->execute();
