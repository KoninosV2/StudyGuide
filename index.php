                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                      	<?php
							$que = $db->prepare("SELECT lesson.lesson_code FROM lesson, teacher2lesson WHERE teacher2lesson.teacher_id = 'Μαλαμάτος' AND teacher2lesson.lesson_code = lesson.lesson_code");
			  				$que->execute();
							echo $que->rowCount();
						  ?>
                      </div>
