        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="book-id" value="<?php echo $book['id']; ?>" readonly>
            </div>
            <div class="form-group col-md-4">
              <label for="book-edition" class="font-weight-bold text-gray-800 col-form-label">Έκδοση:</label>
              <input type="text" class="form-control" name="book-edition" value='<?php echo $book['edition']; ?>'>
            </div>
            <div class="form-group col-md-4">
              <label for="book-year" class="font-weight-bold text-gray-800 col-form-label">Έτος Έκδοσης:</label>
              <input type="text" class="form-control" name="book-year" value='<?php echo $book['year']; ?>'>
            </div>
          </div>
          <div class="form-group">
            <label for="book-title" class="font-weight-bold text-gray-800 col-form-label">Τίτλος Συγγράμματος</label>
            <input type="text" class="form-control" name="book-title" value='<?php echo $book['title']; ?>'>
          </div>
          <div class="form-group">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="book-eudoxus-id" value='<?php echo $book['eudoxus_id']; ?>'> 
            </div>
            <div class="form-group col-md-4">
